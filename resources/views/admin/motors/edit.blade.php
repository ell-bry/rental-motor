...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0 fw-bold"><i class="fa-solid fa-pen-to-square me-2"></i>Edit Armada Motor</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.motors.update', $motor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama_motor" class="form-control @error('nama_motor') is-invalid @enderror" placeholder="Contoh: Vario 150" required value="{{ old('nama_motor', $motor->nama_motor) }}">
                    @error('nama_motor') 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="merk" class="form-control @error('merk') is-invalid @enderror" placeholder="Contoh: Honda" required value="{{ old('merk', $motor->merk) }}">
                    @error('merk') 
                        <div class="invalid-feedback d-block">{{ $message }}</div> 
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="harga_sewa" class="form-control @error('harga_sewa') is-invalid @enderror" placeholder="Contoh: 150000" required value="{{ old('harga_sewa', $motor->harga_sewa) }}">
                    @error('harga_sewa') 
                        <div class="invalid-feedback d-block">{{ $message }}</div> 
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="alert alert-info mt-2 mb-0" role="alert">
                        ...
                        <small>
                            ...
                            <strong>Catatan:</strong> Kosongkan jika tidak ingin mengubah foto. Gambar akan otomatis dikompres untuk performa lebih baik.
                        </small>
                    </div>
                    @error('foto') 
                        <div class="invalid-feedback d-block">{{ $message }}</div> 
                    ...
                    @if($motor->foto)
                        <div class="mt-3">
                            <label class="form-label text-muted d-block mb-2">
                                <i class="fa-solid fa-image me-1"></i><strong>Foto Saat Ini:</strong>
                            </label>
                            <img src="{{ asset('storage/' . $motor->foto) }}" class="img-fluid rounded shadow-sm" style="max-height: 250px;">
                        </div>
                    @else
                        <div class="mt-3 p-3 bg-light rounded text-muted text-center">
                            <i class="fa-solid fa-image fs-5"></i>
                            <p class="mb-0 mt-2">Tidak ada foto saat ini. Silakan upload foto motor.</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('admin.motors.index') }}" class="btn btn-secondary px-4">
